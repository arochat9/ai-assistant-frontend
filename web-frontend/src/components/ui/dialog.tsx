            ...
            <DialogPortal>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <button
                            onClick={() => onOpenChange?.(false)}
                            className="absolute right-4 top-4 rounded-sm p-1 opacity-70 transition-opacity hover:opacity-100 hover:bg-accent active:bg-secondary focus:outline-none disabled:pointer-events-none"
                        >
                            <X className="h-5 w-5" />
